        ...
        <section className="cart-container">
            ...
            <div className="cart-wrapper">
                ...
                -{formatPercentage(item.discountPercent)}
                                    ...
                                    <button className="item-remove" onClick={() => handleRemove(item.sid)}>×</button>
                                </div>
                            ))
                        ) : (
                            <div className="cart-empty">
                                <p>Bạn chưa có sản phẩm nào trong giỏ hàng - quay về <a href="#" title="Trang Chủ" className="link-homepage"> Trang Chủ</a> để
                                    mua hàng</p>
                            </div>
                        )}
                    </div>
